...
```
The K-S test for the normality assumption shows that the `p`-value is 0.2118. So we can not reject the non hypothes that the standardized residuals follow a univariate normal distribution.
